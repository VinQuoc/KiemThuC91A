...
CREATE TABLE `account` (
  ...
  CONSTRAINT `id_employee_fk1` FOREIGN KEY (`id_account`) REFERENCES `employee` (`id_employee`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `order` (
  ...
  KEY `id_employee_fk2_idx` (`id_employee`),
  CONSTRAINT `id_employee_fk2` FOREIGN KEY (`id_employee`) REFERENCES `employee` (`id_employee`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order detail` (
  ...
  PRIMARY KEY (`id_order`),
  KEY `id_room_fk1_idx` (`id_room`),
  CONSTRAINT `id_order_fk_2` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `id_room_fk1` FOREIGN KEY (`id_room`) REFERENCES `room` (`id_room`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order owner` (
  ...
  PRIMARY KEY (`id_order`),
  CONSTRAINT `id_order_fk1` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `room` (
  ...
  `id_category` int NOT NULL,
  PRIMARY KEY (`id_room`),
  KEY `id_category_fk1_idx` (`id_category`),
  CONSTRAINT `id_category_fk1` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system rule` (
  ...
  `ruleName` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_admin` int NOT NULL,
  PRIMARY KEY (`id_rule`),
  KEY `id_admin_fk1_idx` (`id_admin`),
  CONSTRAINT `id_admin_fk1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-29 14:57:56
